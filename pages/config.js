  ...
  return (
    <div className='h-screen items-center'>
        <form className='flex flex-col items-center mt-10 '>
          ...
          <div className='xl:w-1/4 sm:w-full md:w-1/2 p-0' >
            <div className='flex flex-grow'>
            <div className={'border-solid border-2 rounded-md shadow-lg h-5/12 w-5/12 p-5 m-3 hover:cursor-pointer '+
            ...
            <div className={'border-solid border-2 rounded-md shadow-lg h-5/12 w-5/12 p-4 m-3 hover:cursor-pointer '+(state===2?'border-[#664DE5]':'border-gray-400')} onClick={()=>setState(2)}>
              <MdGroups size={30}/>
